...
class SelfPlaySensingWSTRGF(RBCAgentCore):
    """
    ...
    def sense_strategy(self, 
        ...
        if self.train: 
            ...
            obs = generate_input_for_model(board, capture_square, sense_history)
    ...
    def move_strategy(self, moves: List[chess.Move], seconds_left: float, board):
        """
        ...
        print('sample size of boards ', sample_size)
